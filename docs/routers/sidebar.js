  ...
  "/components/": [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "SeamlessTable 无缝表格", link: "/components/seamless-table" },
      ],
    },
  ],
  "/directives/": [
    {
      text: "指令总览",
      items: [{ text: "指令介绍", link: "/directives/" }],
    },
    {
      text: "实用指令",
      items: [{ text: "Directive 指令集合", link: "/directives/directive" }],
    },
  ],
  "/plugins/": [
    {
      text: "插件总览",
      items: [{ text: "插件介绍", link: "/plugins/" }],
    },
    {
      text: "构建插件",
      items: [
